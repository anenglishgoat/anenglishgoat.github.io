...
The basic goal of possession models is to ascribe some 'value' to every single action in a possession. The goalscorer is not solely responsible for a goal being scored -- all of the actions that led up to the ball crossing the line had some impact on the outcome. 

Maybe the keeper rolled it out to a centre back, the centre back pinged a 50 yard diagonal to a winger, the winger beat a defender and whipped in a cross and the striker side footed in from 6 yards.
